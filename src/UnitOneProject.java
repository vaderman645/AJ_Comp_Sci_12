...
public class UnitOneProject {
    static void print (String input){System.out.print(input);}
    static void println (String input){System.out.println(input);}//print methods to save time
    ...
    static void BooleanArrays (boolean Condition1, boolean Condition2, boolean TrueOrFalse){print("  ");//method for boolean arrays, conditions are the arrays in position i, and then it prints the output (TrueOrFalse)
        System.out.print(Condition1);
        if(Condition1 == true){print(" ");}
        print("     |       " + Condition2);
        if(Condition2==true){print(" ");}
        print("      |  " + TrueOrFalse + "\n");}
    static boolean isPerfSquare(double z)//method for perfect square
    {double square = Math.sqrt(z);return ((square - Math.floor(square)) == 0);}
